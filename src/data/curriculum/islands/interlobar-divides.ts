  ...
  activities: [
    {
      ...
      description: 'Video preparation for the compliance relationship used in conventional ventilation.',
      type: 'video',
      estimatedMinutes: 10,
      peepPointsValue: 1,
      ...
      provenance: [
        sourceRef(F07, { kind: 'whole_file' }, 'content', 'Lung Compliance_Video.mp4; container duration was extracted, but no audiovisual transcript was available.'),
        outlineRoster,
      ],
    },
    {
      ...
      description: 'Video preparation for identifying controlled and observed ventilator variables.',
      type: 'video',
      estimatedMinutes: 15,
      peepPointsValue: 2,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(F08, { kind: 'whole_file' }, 'content', 'Independent v Dependent variables_Movie.mp4; container duration was extracted, but no audiovisual transcript was available.'),
        outlineRoster,
      ],
    },
    {
      ...
      sequence: 3,
      title: 'Ventilator Basics: Independent and Dependent Variables',
      description: 'Case-based exploration of airway-protection intubation, mode choice, and initial values for a healthy pediatric lung.',
      type: 'case_vignette',
      estimatedMinutes: 15,
      peepPointsValue: 5,
      countsTowardProgress: true,
      ...
      content: {
        ...
        answer: {
          ...
          rationale: 'The source explicitly records the case decisions as SIMV, PRVC, and Vt 120 mL with PEEP 5, RR 30, and iTime 0.8 seconds. It defines compliance as C = ΔV / ΔP and explains which variable is independent or dependent in each mode.',
        },
        sbar: {
          prompt: 'Summarize the indication for intubation, the child’s initial lung condition, the chosen mode, and the independent and dependent variables in an SBAR handoff to an RT or provider.',
          review: {
            sourceReferences: [
              sourceRef(F02, { kind: 'page', page: 2 }, 'content', 'Airway protection indication and initial prompts.'),
              sourceRef(F02, { kind: 'page', page: 3 }, 'content', 'SIMV/AC definitions and compliance equation.'),
              sourceRef(F02, { kind: 'page', page: 4 }, 'content', 'PC, VC, and PRVC variable definitions.'),
              sourceRef(F02, { kind: 'page', page: 5 }, 'content', 'Healthy-child settings and recorded case decisions.'),
            ],
          },
        },
      },
      provenance: [
        sourceRef(F02, { kind: 'page', page: 2 }, 'content', 'Meet Colby: airway protection rather than respiratory failure.'),
        sourceRef(F02, { kind: 'page', page: 3 }, 'content', 'SIMV versus AC and C = ΔV / ΔP.'),
        sourceRef(F02, { kind: 'page', page: 4 }, 'content', 'PC, VC, and PRVC independent/dependent variables.'),
        sourceRef(F02, { kind: 'page', page: 5 }, 'content', 'Physiologic values and explicit initial-settings decision.'),
        outlineRoster,
      ],
    },
    {
      ...
      description: 'Roster-required decision-tree video slot; the verified source extraction does not contain a learner-readable decision-tree video payload.',
      type: 'video',
      estimatedMinutes: 5,
      peepPointsValue: 1,
      countsTowardProgress: true,
      ...
      provenance: [
        outlineRoster,
        sourceRef(F03, { kind: 'slide', slide: 1 }, 'review', 'The mode deck has a mode-determination title, but its extracted slides are a quiz rather than a decision-tree video.'),
      ],
    ...
    },
    {
      ...
      description: 'Graphic comparison of pressure-control and pressure-regulated-volume-control priorities and their shared decelerating-flow waveform.',
      type: 'reading',
      estimatedMinutes: 5,
      peepPointsValue: 1,
      countsTowardProgress: true,
      ...
      content: {
        ...
        confirmationQuestion: {
          ...
          review: {
            rationale: 'The graphic explicitly labels decelerating flow as the key overlap between PC and PRVC; it distinguishes guaranteed Vt as a PRVC advantage and clinician-controlled PIP as a PC advantage.',
            sourceReferences: [sourceRef(F01, { kind: 'whole_file' }, 'content', 'Visible comparison graphic and key-overlap panel.')],
          },
        },
      },
      provenance: [
    ...
    },
    {
      ...
      description: 'Vent-lab mode identification using three ventilator-screen questions, their set and measured settings, and flow diagrams.',
      type: 'vent_lab',
      estimatedMinutes: 10,
      peepPointsValue: 3,
      countsTowardProgress: true,
      ...
      content: {
        ...
        feedback: {
          success: 'The source answer key maps Slide 2 to SIMV PRVC, Slide 3 to SIMV PC, and Slide 4 to CPAP/PS.',
          incorrect: 'Re-check the selected screen’s set settings, measured settings, and flow diagrams before choosing a mode.',
          review: {
            notes: 'The deck’s ventilator-screen pixels were not OCR-transcribed. The mode labels, options, and speaker-note answer mapping are preserved; set/measured values are intentionally not recreated.',
            sourceReferences: [
              sourceRef(F03, { kind: 'slide', slide: 2 }, 'content', 'Question/options and first ventilator-screen images.'),
              sourceRef(F03, { kind: 'slide', slide: 3 }, 'content', 'Question/options and second ventilator-screen images.'),
              sourceRef(F03, { kind: 'slide', slide: 4 }, 'content', 'Question/options and third ventilator-screen images.'),
              sourceRef(F03, { kind: 'slide', slide: 2 }, 'answer', 'Speaker-note answer: SIMV PRVC.'),
              sourceRef(F03, { kind: 'slide', slide: 3 }, 'answer', 'Speaker-note answer: SIMV PC.'),
              sourceRef(F03, { kind: 'slide', slide: 4 }, 'answer', 'Speaker-note answer: CPAP/PS.'),
            ],
          },
        },
      },
      provenance: [
        sourceRef(F03, { kind: 'slide', slide: 2 }, 'content', 'Mode-identification question and options.'),
        sourceRef(F03, { kind: 'slide', slide: 3 }, 'content', 'Mode-identification question and options.'),
        sourceRef(F03, { kind: 'slide', slide: 4 }, 'content', 'Mode-identification question and options.'),
        sourceRef(F03, { kind: 'slide', slide: 2 }, 'answer', 'Answer key mapping for first question.'),
        sourceRef(F03, { kind: 'slide', slide: 3 }, 'answer', 'Answer key mapping for second question.'),
        sourceRef(F03, { kind: 'slide', slide: 4 }, 'answer', 'Answer key mapping for third question.'),
        outlineRoster,
      ],
    ...
    },
    {
      ...
      description: 'Branching ventilator-settings case for an intubated patient with sickle-cell acute chest syndrome; incomplete source branches remain reviewable rather than receiving invented answers.',
      type: 'case_vignette',
      estimatedMinutes: 10,
      peepPointsValue: 5,
      countsTowardProgress: true,
      ...
      content: {
        ...
        sbar: {
          prompt: 'Summarize the acute chest syndrome presentation, current ventilator mode and settings selected from the case, observed oxygenation/pressure response, and the next branch to discuss with the RT or provider.',
          review: {
            notes: 'This alternate case implementation is partially authored. The source does not supply correct values or transitions for its “give remaining answers” prompts, and its PRVC tidal-volume branch asks for a pressure-control change.',
            sourceReferences: [sourceRef(F13, { kind: 'whole_file' }, 'review', 'Incomplete branch authoring and terminology conflicts.')],
          },
        },
      },
      provenance: [
        sourceRef(F13, { kind: 'whole_file' }, 'content', 'Case start, mode options, branch values, and documented branch outcomes.'),
        outlineRoster,
      ],
    ...
    },
    {
      ...
      description: 'Bedside quest to identify mode variables and assess compliance with an RT partner; the source provides two repeat variants.',
      type: 'quest',
      estimatedMinutes: 15,
      peepPointsValue: 5,
      countsTowardProgress: true,
      ...
      content: {
        ...
        supervisorRole: 'Respiratory therapist partner who reviews the bedside mode, variables, scalars, compliance assessment, and feedback.',
        offlineValidation: {
          method: 'supervisor_confirmation',
          evidenceFields: ['modeAssessment', 'dependentVariable', 'independentVariable', 'complianceAssessment', 'rtFeedback'],
        },
        repeatCount: 2,
        review: {
          notes: 'Quest 2 and Quest 3 are near-template alternates. Quest 3 asks for a different RT and different patient; Quest 2 asks for an RT and a patient. Neither source supplies an answer key. Both images print the independent/dependent examples opposite to the canonical definitions used in F02: the images label PIP in PC and Vt in PRVC as dependent, and Vt in PC and PIP in PRVC as independent. The catalog keeps the F02-consistent mapping and flags this source contradiction for manual review.',
          sourceReferences: [
    ...
    },
    {
      ...
      provenance: [
        sourceRef(F10, { kind: 'whole_file' }, 'media', 'Direct CVICU Ventilator Considerations_Video.MOV source copy; audiovisual transcript unavailable.'),
        sourceRef(F05, { kind: 'slide', slide: 2 }, 'media', 'Slide 2 embeds the matching CVICU Ventilator Considerations media item and poster.'),
        outlineRoster,
      ],
    },
    {
      ...
      description: 'Named CCDH ventilator-considerations video; the verified binary source provides container metadata but no audiovisual transcript.',
      type: 'video',
      estimatedMinutes: 10,
      peepPointsValue: 1,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(F12, { kind: 'whole_file' }, 'media', 'CCDH considerations.MOV filename and container metadata; no audiovisual transcript was available.'),
        sourceRef(F02, { kind: 'page', page: 4 }, 'review', 'The case notes that CDH uses PC, which supports but does not establish the video topic mapping.'),
        outlineRoster,
      ],
    ...
    },
    {
      ...
      description: 'Clinical case from airway-protection intubation through rising PRVC pressures, oxygenation-index calculation, pARDS severity, and PC/ARDS confirmation.',
      type: 'case_vignette',
      estimatedMinutes: 20,
      peepPointsValue: 5,
      countsTowardProgress: true,
      ...
      content: {
        ...
        answer: {
          acceptedDecisionIds: ['airway-protection', 'simv-prvc', 'initial-values', 'pressure-survival-guide', 'oi-twelve', 'moderate-pards', 'pc-ards'],
          rationale: 'These decisions follow the explicit page-by-page case outcomes. The source preserves conflicting PIP units, OI fraction-versus-percentage notation, “30s” pressure wording, and a small iTime/I:E arithmetic mismatch; those source conflicts are not silently corrected.',
        },
        sbar: {
          prompt: 'Give an SBAR handoff for Colby’s deterioration: state the influenza A insult and timing, current ventilator support and rising pressures, reversible checks completed, OI and pARDS severity, and the lung-protective mode/volume decision.',
          review: {
            sourceReferences: [
              sourceRef(F02, { kind: 'page', page: 5 }, 'content', 'Initial healthy-lung settings.'),
              sourceRef(F02, { kind: 'page', page: 6 }, 'content', 'Rising PRVC pressures and reversible-cause guide.'),
              sourceRef(F02, { kind: 'page', page: 7 }, 'content', 'OI formula and worked calculation.'),
              sourceRef(F02, { kind: 'page', page: 8 }, 'content', 'pARDS severity ranges.'),
              sourceRef(F02, { kind: 'page', page: 9 }, 'content', 'Pressure–volume relationship and SIMV/PC branch.'),
      ...
      provenance: [
        ...
        sourceRef(F02, { kind: 'page', page: 5 }, 'content', 'Initial settings for a healthy lung.'),
        sourceRef(F02, { kind: 'page', page: 6 }, 'content', 'Deterioration and rising peak-pressure branch.'),
    ...
    },
    {
      ...
      description: 'Roster-required final-exam slot; no final-exam question set was present in the verified Interlobar source extraction.',
      type: 'quiz',
      estimatedMinutes: 20,
      peepPointsValue: 0,
      ...
      provenance: [
        outlineRoster,
        sourceRef(F02, { kind: 'whole_file' }, 'review', 'The case is instructional source material, not a final-exam answer key or question set.'),
      ],
  ...
  conflicts: [
    {
      ...
      scope: 'mapping',
      status: 'unavailable',
      message: 'The canonical roster includes a five-minute “Ventilator Modes: The Decision Trees” video, but the verified Interlobar extraction contains no learner-readable decision-tree video payload. The nearby mode deck is a quiz with image-only screen captures.',
    ...
    },
    {
      ...
      scope: 'content',
      status: 'needs_review',
      message: 'The three mode-identification answer mappings are present in speaker notes, but the embedded ventilator-screen pixels were not OCR-transcribed. The lab therefore does not invent screen values.',
    ...
    },
    {
      ...
      scope: 'content',
      status: 'needs_review',
      message: 'The choosing-a-mode DOCX repeatedly asks the author to give remaining answers and supplies no correct values or transitions for those branches.',
    ...
    },
    {
      ...
      scope: 'content',
      status: 'needs_review',
      message: 'The PRVC branch labels its parameter Tidal Volume but then asks what PC should change to; the source also may conflate pressure control/delta P with total PIP.',
      sourceIds: ['source-638af99195c598411f75'],
      activityIds: ['id-07'],
    ...
    },
    {
      ...
      scope: 'content',
      status: 'needs_review',
      message: 'The Quest 2 and Quest 3 images label the independent/dependent examples opposite to the canonical definitions in the F02 case: PC sets pressure and observes Vt, while PRVC sets Vt and observes pressure. The catalog uses the canonical mapping and preserves the source labels for manual review.',
      sourceIds: ['source-bc09dd734ce7f408914b', 'source-a7334f339fa443c85f65', 'source-c5425d9e98ed0863a367'],
      activityIds: ['id-08'],
    ...
    },
    {
      ...
      scope: 'mapping',
      status: 'needs_review',
      message: 'The CCDH video is linked to this roster slot from its filename and the F02 note that CDH uses PC; no direct package relationship or audiovisual transcript establishes the topic.',
    ...
    },
    {
      ...
      scope: 'content',
      status: 'needs_review',
      message: 'F02 preserves printed PIP unit alternation (mmHg/cmH₂O), fraction-versus-percentage OI notation, “30s” pressure wording, and a small iTime/I:E arithmetic mismatch. The catalog carries the source values without correcting them.',
    ...
    },
    {
      ...
      scope: 'totals',
      status: 'needs_review',
      message: 'GameOutline declares 10 activities, 135 minutes, and 34 PEEP points for Interlobar Divides (the 135/34 values include the Quest repeat). The canonical roster adds the Decision Trees slot and the final-exam slot, so observed catalog records are 12 activities, 145 minutes, and 30 points.',
    ...
    },
    {
      ...
      scope: 'activity',
      status: 'unavailable',
      message: 'The canonical final-exam descriptor is required, but no final-exam question set or answer key appears in the verified Interlobar source corpus.',
