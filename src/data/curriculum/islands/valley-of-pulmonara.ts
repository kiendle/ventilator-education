...
const vaporPreventionQuestion = {
  ...
  choices: [
    ...
    {
      id: 'item-07',
      text: 'Use prophylactic systemic antibiotics to prevent VAP in ventilated patients.',
    },
    {
      id: 'item-08',
    ...
    {
      id: 'item-12',
      text: 'Routinely disconnect the ventilator circuit to reposition the patient.',
    },
    {
      id: 'item-13',
    ...
    {
      id: 'item-15',
      text: 'Use prophylactic inhaled antibiotics in intubated patients to prevent VAP.',
    },
    {
      id: 'item-16',
  ...
  review: {
    rationale: exactSourceText(vapQuiz),
    notes:
    ...
    sourceReferences: [
      sourceRef(
        ...
        { kind: 'whole_file' },
        'answer',
        '21-item answer-bearing prevention classification and rationales'
      ),
    ],
  },
}
...
export const valleyOfPulmonaraIsland: CurriculumIsland = {
  ...
  conflicts: [
    ...
    },
    {
      ...
      status: 'ready',
      message:
        'EAT considerstions.mov has no transcript or OCR. The release accepts the filename-to-roster mapping and presents the original audiovisual source without invented instructional text.',
    ...
    },
    {
      ...
      status: 'ready',
      message:
        'Quest 4 Scenario 3 states that too many causes prevent isolating one cause, keys generalized clinical deterioration, and labels the worsening sepsis/pneumonia presentation Semi-Urgent. The released activity preserves that source-authored decision.',
    ...
    },
    {
      ...
      status: 'ready',
      message:
        'The VAP lecture includes cited incidence, pathogen, diagnostic, and sequelae claims that extraction did not independently validate. The released reading presents them explicitly as source-authored lecture content.',
  ...
  activities: [
    {
      ...
      description:
        'Gamer ICU bronchiolitis video; the Valley source inventory identifies the file as Bronchiolitis_GAMERICU.',
      type: 'video',
      estimatedMinutes: 10,
      peepPointsValue: 2,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'content',
          'Bronchiolitis_GAMERICU audiovisual source'
        ),
    ...
    },
    {
      ...
      description:
        'Gamer ICU critical-asthma video; the paired SBAR source also uses an intubated child with status asthmaticus and high peak pressure.',
      type: 'video',
      estimatedMinutes: 10,
      peepPointsValue: 2,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'content',
          'CriticalAsthma_Gamer_ICU audiovisual source'
        ),
        sourceRef(
          quest4,
          { kind: 'whole_file' },
          'review',
          'Quest 4 Scenario 1: child with asthma and high peak pressure'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'The roster requires a video, but the available TBM evidence is an image-heavy nursing PPTX with no Valley TBM video.',
      type: 'video',
      estimatedMinutes: 10,
      peepPointsValue: 2,
      countsTowardProgress: true,
      ...
      content: null,
      conflictIds: [
        'vp-03-video-source-unavailable',
        'tbm-management-slide-missing',
        'tbm-image-led-evidence',
      ],
      provenance: [
        sourceRef(
          tbmLecture,
          { kind: 'slide', slide: 4 },
          'review',
          'Normal versus malacic tissue; airway flattening and narrowing'
        ),
        sourceRef(
          tbmLecture,
          { kind: 'slide', slide: 5 },
          'content',
          'Congenital and acquired TBM causes'
        ),
        sourceRef(
          tbmLecture,
          { kind: 'slide', slide: 6 },
          'content',
          'TBM pathophysiology: airway resistance, distress, air trapping'
        ),
        sourceRef(
          tbmLecture,
          { kind: 'slide', slide: 7 },
          'content',
          'TBM clinical manifestations'
        ),
        ...
        sourceRef(
          ...
          { kind: 'slide', slide: 10 },
          'review',
          'Management and Nursing Considerations heading only'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      provenance: [
        ...
        sourceRef(
          ...
          { kind: 'slide', slide: 13 },
          'content',
          'Trauma patient with developing ARDS'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Reading extracted from the Vent Lab ARDS cases: PEEP titration, beaking/overdistention, and worsening compliance in PRVC.',
      type: 'reading',
      estimatedMinutes: 5,
      peepPointsValue: 1,
      countsTowardProgress: true,
      contentStatus: 'ready',
      content: {
        blocks: exactSourceBlocks(ventLab),
        body: exactSourceText(ventLab),
        confirmationQuestion: {
          prompt: 'In the Vent Lab explanation, what does a “beaking” curve indicate?',
          choices: [
            {
              id: 'overdistention',
              text: 'Overdistention of the alveoli compromising gas exchange',
            },
          ...
          review: {
            explanation: exactSourceText(ventLab),
            sourceReferences: [
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 15 },
                'answer',
                'Beaking indicates overdistention compromising gas exchange'
              ),
            ],
          },
        },
      ...
      provenance: [
        ...
        sourceRef(
          ...
          { kind: 'slide', slide: 15 },
          'answer',
          'PEEP titration and beaking explanation'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 16 },
          'content',
          'Trauma/ARDS case 5 with high peak pressures'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 17 },
          'answer',
          'Case 5 keyed answer: underlying disease worsening'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 18 },
          'content',
          'PRVC compliance and PIP explanation'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'The captured video file is retained as an unavailable slot because its topic and instructional mapping were not recovered.',
      type: 'video',
      estimatedMinutes: 5,
      peepPointsValue: 1,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'review',
          'Captured_Video.mp4; no transcript, OCR, or topic mapping'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'No matching Valley video was extracted; alarm causes and urgency are documented in the two SBAR quest sources.',
      type: 'video',
      estimatedMinutes: 15,
      peepPointsValue: 3,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'content',
          'High peak pressure, low minute volume, and high respiratory rate alarm cases'
        ),
        sourceRef(
          quest5,
          { kind: 'whole_file' },
          'content',
          'High respiratory rate, high pressure, and high PEEP alarm cases'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Audiovisual EAT-considerations asset; transcript and exact instructional role remain unavailable.',
      type: 'video',
      estimatedMinutes: 5,
      peepPointsValue: 1,
      countsTowardProgress: true,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'media',
          'Filename suggests EAT considerations; no transcript or OCR'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Vent Lab waveform/loop interaction containing five source cases with retry behavior and instructor answer slides.',
      type: 'vent_lab',
      estimatedMinutes: 10,
      peepPointsValue: 5,
      countsTowardProgress: true,
      ...
      content: {
        controls: [
          {
            ...
            kind: 'select',
            options: [
              'Case 1: RSV bronchiolitis',
              'Case 2: broncholitic infant dysynchrony',
              'Case 3: broncholitic infant secretions/condensation',
              'Case 4: trauma/ARDS with PEEP 16',
              'Case 5: trauma/ARDS with high peak pressure',
            ],
          },
          {
            id: 'answer',
            ...
            options: [
              ...
              'They need more sedation',
              'Their underlying disease is worsening',
              'They are not fully exhaling',
              'The patient is overdistended',
            ],
          },
        ...
        feedback: {
          ...
          review: {
            notes:
              'The answer letters are on instructor slides 3, 8, 11, 14, and 17. Keep these explanations gated until the learner attempts each case.',
            sourceReferences: [
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 3 },
                'answer',
                'Case 1 keyed answer: not fully exhaling'
              ),
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 8 },
                'answer',
                'Case 2 keyed answer: more sedation'
              ),
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 11 },
                'answer',
                'Case 3 keyed answer: suctioning'
              ),
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 14 },
                'answer',
                'Case 4 keyed answer: overdistention'
              ),
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 17 },
      ...
      conflictIds: [
        'vent-lab-answer-slides-instructor',
        'vent-lab-source-defects',
        'vp-09-vp-10-roster-split',
      ],
      provenance: [
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 2 },
          'content',
          'Case 1 RSV bronchiolitis waveform prompt'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 7 },
          'content',
          'Case 2 broncholitic infant waveform prompt'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 10 },
          'content',
          'Case 3 secretions/condensation waveform prompt'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 13 },
          'content',
          'Case 4 trauma/ARDS waveform prompt'
        ),
        sourceRef(
          ventLab,
          { kind: 'slide', slide: 16 },
          'content',
          'Case 5 trauma/ARDS high-peak-pressure prompt'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      content: {
        ...
        sbar: {
          prompt:
            'After selecting the source-keyed explanation, communicate the high-pressure alarm, ARDS context, and assessment to the respiratory team using SBAR.',
          review: {
            notes:
              'This case is split from the Vent Lab interaction for the canonical Clinical Case Vignette slot; the source answer remains instructor material.',
            sourceReferences: [
              sourceRef(
                ventLab,
                { kind: 'slide', slide: 16 },
              ...
              sourceRef(
                ...
                { kind: 'slide', slide: 18 },
                'content',
                'PRVC worsening-compliance explanation'
              ),
            ],
          },
        },
    ...
    },
    {
      ...
      description:
        'Quest 4 SBAR practice for three alarm cases: status asthmaticus, premature-neonate low minute volume, and sepsis/pneumonia high respiratory rate.',
      type: 'quest',
      estimatedMinutes: 20,
      peepPointsValue: 10,
      countsTowardProgress: true,
      ...
      content: {
        ...
        review: {
          notes:
            'The source developer note requires Possible Causes, Likely Cause, Urgency, and Example SBAR to remain helpful hints or RT-only material until the learner attempts the quest.',
          sourceReferences: [
            sourceRef(
              quest4,
              { kind: 'whole_file' },
              'content',
              'Quest 4 instructions and Scenarios 1–3'
            ),
            sourceRef(
              quest4,
              { kind: 'whole_file' },
              'answer',
              'Embedded possible causes, likely causes, urgency, and example SBARs'
            ),
          ],
        },
      },
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'content',
          'Quest 4 SBAR instructions and scenarios 1–3'
        ),
        sourceRef(
          quest4,
          { kind: 'whole_file' },
          'answer',
          'Quest 4 keyed causes, urgency, and example SBARs'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Quest 5 SBAR practice for three alarm cases; the canonical roster labels this supervisor role Provider while the source directs presentation to an RT.',
      type: 'quest',
      estimatedMinutes: 20,
      peepPointsValue: 10,
      countsTowardProgress: true,
      ...
      content: {
        ...
        supervisorRole:
          'Provider (canonical roster role; source currently directs the learner to an RT)',
        offlineValidation: {
          method: 'supervisor_confirmation',
          evidenceFields: [
            'scenario',
        ...
        review: {
          notes:
            'Keep Possible Causes, Likely Cause, Urgency, and Example SBAR gated until the learner attempts the quest. The source does not supply a provider QR destination or scoring endpoint.',
          sourceReferences: [
            sourceRef(
              quest5,
              { kind: 'whole_file' },
              'content',
              'Quest 5 instructions and Scenarios 4–6'
            ),
            sourceRef(
              quest5,
              { kind: 'whole_file' },
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'content',
          'Quest 5 SBAR instructions and scenarios 4–6'
        ),
        sourceRef(
          quest5,
          { kind: 'whole_file' },
          'answer',
          'Quest 5 keyed causes, urgency, and example SBARs'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Reading/graphic drawn from the VAP lecture’s definition, development, diagnosis, pediatric VAE, sequelae, and conclusion slides.',
      type: 'reading',
      estimatedMinutes: 10,
      peepPointsValue: 2,
      countsTowardProgress: true,
      contentStatus: 'ready',
      content: {
        blocks: exactSourceBlocks(vapLecture),
        body: exactSourceText(vapLecture),
        confirmationQuestion: {
          prompt:
            'According to the VAP lecture, when does a new pneumonia meet its definition of ventilator-associated pneumonia?',
          choices: [
            {
              id: 'more-than-48-hours',
              text: 'When it occurs after more than 48 hours of mechanical ventilation',
            },
          ...
          review: {
            explanation: exactSourceText(vapLecture),
            sourceReferences: [
              sourceRef(
                vapLecture,
                { kind: 'slide', slide: 2 },
                'content',
                'VAP definition after more than 48 hours of mechanical ventilation'
              ),
            ],
          },
        },
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'slide', slide: 2 },
          'content',
          'VAP definition and PICU context'
        ),
        sourceRef(
          vapLecture,
          { kind: 'slide', slide: 4 },
          'content',
          'Aspiration and VAP development'
        ),
        ...
        sourceRef(
          ...
          { kind: 'slide', slide: 6 },
          'content',
          'PedVAE diagnostic consideration'
        ),
    ...
    },
    {
      ...
      description:
        'Twenty-one-item drag-and-drop classification into Strong Evidence, Limited Evidence, and Not recommended.',
      type: 'quiz',
      estimatedMinutes: 5,
      peepPointsValue: 2,
      countsTowardProgress: true,
      ...
      conflictIds: [
        'vap-oral-care-contradiction',
        'vap-quiz-answer-bearing',
        'vap-item-21-exception',
      ],
      provenance: [
        ...
        sourceRef(
          ...
          { kind: 'slide', slide: 7 },
          'review',
          'Lecture prevention bundle including chlorhexidine oral care'
        ),
        outlineRoster,
      ],
    },
    {
      ...
      description:
        'Final-exam descriptor retained from the canonical roster; no Valley final-exam question payload was extracted.',
      type: 'quiz',
      estimatedMinutes: 20,
      peepPointsValue: 0,
      ...
      provenance: [
        sourceRef(
          ...
          { kind: 'whole_file' },
          'review',
          'The corpus contains a 21-item VAP quiz but no final-exam question set'
        ),
        outlineRoster,
      ],
    },
