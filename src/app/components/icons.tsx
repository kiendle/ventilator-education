/* Minimal inline SVG icon set for the shell, learning activities, and utility
   states. Stroke icons inherit currentColor so active and inactive states follow
   the design tokens. */
...
export const PlayIcon = (p: IconProps) => stroke(p, <path d="M6 4.5v15l13-7.5L6 4.5Z" />)
...
export const CheckIcon = (p: IconProps) => stroke(p, <path d="m4 12.5 5 5L20 6.5" />)
